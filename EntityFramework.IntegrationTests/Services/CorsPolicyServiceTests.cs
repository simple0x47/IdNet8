...
using IdNet8.EntityFramework.DbContexts;
using IdNet8.EntityFramework.Mappers;
using IdNet8.Models;
using Microsoft.EntityFrameworkCore;
using Xunit;
using System.Linq;
using IdNet8.EntityFramework.Options;
using Microsoft.AspNetCore.Http;
using Microsoft.Extensions.DependencyInjection;
using IdNet8.EntityFramework.Interfaces;
using IdNet8.EntityFramework.Services;

namespace IdNet8.EntityFramework.IntegrationTests.Services
{
    public class CorsPolicyServiceTests : IntegrationTest<CorsPolicyServiceTests, ConfigurationDbContext, ConfigurationStoreOptions>
    {
        ...
        public void IsOriginAllowedAsync_WhenOriginIsAllowed_ExpectTrue(DbContextOptions<ConfigurationDbContext> options)
        {
            ...
            using (var context = new ConfigurationDbContext(options, StoreOptions))
            {
                ...
                {
                    AllowedIdentityTokenSigningAlgorithms = new List<string>() {"a"},
