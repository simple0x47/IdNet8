...
using IdNet8.Endpoints.Results;
...
namespace IdentityServer.UnitTests.Endpoints.Results
{
    public class AuthorizeResultTests
    {
        ...
        private MockMessageStore<IdNet8.Models.ErrorMessage> _mockErrorMessageStore = new MockMessageStore<IdNet8.Models.ErrorMessage>();
