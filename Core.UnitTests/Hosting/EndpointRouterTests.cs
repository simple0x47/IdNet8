...
using IdNet8.Hosting;
using Microsoft.AspNetCore.Http;
using Xunit;
using static IdNet8.Constants;

namespace IdentityServer.UnitTests.Hosting
{
    public class EndpointRouterTests
    {
        private Dictionary<string, IdNet8.Hosting.Endpoint> _pathMap;
        private List<IdNet8.Hosting.Endpoint> _endpoints;
        private IdentityServerOptions _options;
        private EndpointRouter _subject;

        public EndpointRouterTests()
        {
            _pathMap = new Dictionary<string, IdNet8.Hosting.Endpoint>();
            _endpoints = new List<IdNet8.Hosting.Endpoint>();
        ...
        {
            Action a = () => new IdNet8.Hosting.Endpoint("ep1", "ep1", typeof(MyEndpointHandler));
        ...
        {
            _endpoints.Add(new IdNet8.Hosting.Endpoint("ep1", "/ep1", typeof(MyEndpointHandler)));
            _endpoints.Add(new IdNet8.Hosting.Endpoint("ep2", "/ep2", typeof(MyOtherEndpointHandler)));
        ...
        {
            _endpoints.Add(new IdNet8.Hosting.Endpoint("ep1", "/ep1", typeof(MyEndpointHandler)));
            _endpoints.Add(new IdNet8.Hosting.Endpoint("ep1", "/ep1", typeof(MyOtherEndpointHandler)));
        ...
        {
            _endpoints.Add(new IdNet8.Hosting.Endpoint(EndpointNames.Authorize, "/ep1", typeof(MyEndpointHandler)));
            _endpoints.Add(new IdNet8.Hosting.Endpoint("ep2", "/ep2", typeof(MyOtherEndpointHandler)));
