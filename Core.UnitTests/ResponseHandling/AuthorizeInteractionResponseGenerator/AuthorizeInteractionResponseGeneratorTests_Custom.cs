...
{
    public class CustomAuthorizeInteractionResponseGenerator : IdNet8.ResponseHandling.AuthorizeInteractionResponseGenerator
    {
        public CustomAuthorizeInteractionResponseGenerator(ISystemClock clock, ILogger<IdNet8.ResponseHandling.AuthorizeInteractionResponseGenerator> logger, IConsentService consent, IProfileService profile) : base(clock, logger, consent, profile)
        {
        }
    ...
    public class AuthorizeInteractionResponseGeneratorTests_Custom
    {
        ...
        public AuthorizeInteractionResponseGeneratorTests_Custom()
        {
            _subject = new CustomAuthorizeInteractionResponseGenerator(
                _clock,
                TestLogger.Create<IdNet8.ResponseHandling.AuthorizeInteractionResponseGenerator>(),
                _mockConsentService,
