...
using Xunit;
using ApiResource = IdNet8.Models.ApiResource;

namespace IdNet8.EntityFramework.UnitTests.Mappers
{
    public class ApiResourceMappersTests
    {
        ...
        {
            var entity = new IdNet8.EntityFramework.Entities.ApiResource
            {
