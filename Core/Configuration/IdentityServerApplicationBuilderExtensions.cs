...
namespace Microsoft.AspNetCore.Builder
{
    ...
    public static class IdentityServerApplicationBuilderExtensions
    {
        ...
        internal static void Validate(this IApplicationBuilder app)
        {
            ...
            var logger = loggerFactory.CreateLogger("IdNet8.Startup");
            logger.LogInformation("Starting IdNet8 version {version}", typeof(IdNet8.Hosting.IdentityServerMiddleware).Assembly.GetCustomAttribute<AssemblyInformationalVersionAttribute>().InformationalVersion);
