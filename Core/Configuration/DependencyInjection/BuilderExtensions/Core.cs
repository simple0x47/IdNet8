...
using IdNet8.Configuration.DependencyInjection;
using IdNet8.Endpoints;
using IdNet8.Events;
using IdNet8.Hosting;
using IdNet8.ResponseHandling;
using IdNet8.Services;
using IdNet8.Stores;
using IdNet8.Stores.Serialization;
...
using IdNet8.Extensions;
using IdNet8.Hosting.FederatedSignOut;
using IdNet8.Services.Default;
...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static class IdentityServerBuilderExtensionsCore
    {
            ...
            where T : class, IEndpointHandler
        {
            ...
            builder.Services.AddSingleton(new IdNet8.Hosting.Endpoint(name, path, typeof(T)));
